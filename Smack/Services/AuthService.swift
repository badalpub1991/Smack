...
class AuthService {
    ...
    func createUser (name:String, email:String, avtarName:String, avtarColor:String, complition: @escaping ComplitionHandler) {
    ...
    func findUserByEmail (complition: @escaping ComplitionHandler) {
    ...
    func setUserInfo (data: Data) {
        do {
            ...
            UserDataService.instance.setUserData(id: id, color: color, avtarName: avatarName, email: email, name: name)
        } catch {
